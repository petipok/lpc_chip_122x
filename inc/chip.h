/*
 * @brief LPC122x basic chip inclusion file
 *
...
warning message, define ENABLE_UNTESTED_CODE.
	...
	!defined(CHIP_LPC1125) && !defined(CHIP_LPC122X)
...
/** @ingroup CHIP_122X_DRIVER_OPTIONS
 */
...
#include "pmu_122x.h"
//#include "fmc_11xx.h"
#include "sysctl_122x.h"
#include "clock_122x.h"
#include "iocon_122x.h"
#include "timer_122x.h"
#include "uart_122x.h"
#include "wwdt_122x.h"
#include "ssp_122x.h"
#include "adc_122x.h"
...
/** @defgroup SUPPORT_122X_FUNC CHIP: LPC122x support functions
