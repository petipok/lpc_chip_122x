/*
 * @brief  LPC122x A/D conversion driver (except LPC1125)
 *
 *
 * @note
...
#ifndef __ADC_122X_H_
#define __ADC_122X_H_
...
/** @defgroup ADC_122X CHIP:  LPC122x A/D conversion driver
 * @ingroup CHIP_122X_Drivers
 * This ADC driver is for LPC122x variants except for LPC1125.
 * @{
 */
