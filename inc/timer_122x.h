/*
 * @brief LPC122x 16/32-bit Timer/PWM control functions
 *
 * @note
...
#ifndef __TIMER_122X_H_
#define __TIMER_122X_H_

#ifdef __cplusplus
extern "C" {
#endif

/** @defgroup TIMER_122X CHIP: LPC122x 16/32-bit Timer driver
