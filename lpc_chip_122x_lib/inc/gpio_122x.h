...
#ifndef __GPIO_122X_1_H_
#define __GPIO_122X_1_H_
...
typedef struct {				/*!< GPIO_PORT Structure */
	__IO uint32_t MASK;			/*!< Offset 0x000: MASK register */
	__I  uint32_t PIN;			/*!< Offset 0x004: PIN value registern */
	__IO uint32_t OUT;			/*!< Offset 0x008: Pin output value register */
	__O  uint32_t SET;			/*!< Offset 0x00C: Pin output value set register */
	__O  uint32_t CLR;			/*!< Offset 0x010: Pin output value clear register */
	__O  uint32_t NOT;			/*!< Offset 0x014: Pin output value invert register */
	__I  uint32_t RESERVED_0;	/*!< Offset 0x018: Reserved */
	__I  uint32_t RESERVED_1;	/*!< Offset 0x01C: Reserved */
	__IO uint32_t DIR;			/*!< Offset 0x020: Data direction register */
	__IO uint32_t IS;			/*!< Offset 0x024: Interrupt sense register */
	__IO uint32_t IBE;			/*!< Offset 0x028: Interrupt bothe edges register */
	__IO uint32_t IEV;			/*!< Offset 0x02c: Interrupt event register */
	__IO uint32_t IE;			/*!< Offset 0x030: Interrupt mask register */
	__I  uint32_t RIS;			/*!< Offset 0x034: Raw interrupt status register */
	__I  uint32_t MIS;			/*!< Offset 0x038: Masked interrupt status register */
	__O  uint32_t IC;			/*!< Offset 0x03c: Interrupt clear register */
	__I  uint32_t RESERVED2;	/*!< Offset 0x040: Pin output value invert register */
} LPC_GPIO_T;
...
{
	return (bool) (pGPIO[port].PIN & 1<<pin);
}
